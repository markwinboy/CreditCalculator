...
<div class="result">
    <h2>Вы возвращаете: <% Object allSum = request.getAttribute("allSum");
        out.print(allSum);
        %>р.</h2>
    <h2>Сумма ежемесячного платежа: <% Object monthPaymentSum = request.getAttribute("monthPaymentSum");
        out.print(monthPaymentSum);
        %>р.</h2>
    <h2>Срок займа до: <% Object date = request.getAttribute("date");
            out.print(date);
            %></h2>
    <h2>Процентная ставка: <% Object monthInterestRate = request.getAttribute("monthInterestRate");
            out.print(monthInterestRate);
            %>%</h2>
</div>
